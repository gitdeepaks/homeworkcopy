...
import { NotFoundError, ProviderTimeoutError, UnauthorizedError } from "./app-error.js";
...
describe("stable application errors", () => {
    test("exposes stable codes and statuses", () => {
        ...
        expect(new ProviderTimeoutError("Provider")).toMatchObject({ statusCode: 504, code: "PROVIDER_TIMEOUT" });
    });
});
